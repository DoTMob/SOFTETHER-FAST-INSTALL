...
```yum install wget -y && wget https://github.com/DoTMob/SOFTETHER-FAST-INSTALL/master/Debian%20and%20Ubuntu/installer.sh && chmod +x installer.sh && ./installer.sh```<br /><br /><br />


<b>For debian and ubuntu</b> (copy all the text below and paste on your terminal)<br /><br />
```wget https://github.com/DoTMob/SOFTETHER-FAST-INSTALL/master/Debian%20and%20Ubuntu/installer.sh && chmod +x installer.sh && ./installer.sh```<br /><br /><br />
